...
- [ADR-0005: Slack plugin native drafts](adr-0005-slack-plugin-native-drafts.md) — ADR-0002 chose Slack DM-to-self staging because it was safe and available at the time. (2026-06-18, Proposed)
- [ADR-0006: Codex automations for scheduled runs](adr-0006-codex-automations-for-scheduled-runs.md) — Morning Assistant should run on a schedule. (2026-06-18, Proposed)
